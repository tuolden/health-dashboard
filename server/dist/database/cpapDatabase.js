...
exports.closeCpapPool = exports.getCpapDbStats = exports.testCpapConnection = exports.cpapPool = void 0;
...
exports.cpapPool = new pg_1.Pool(cpapDbConfig);
// Test CPAP database connection
const testCpapConnection = async () => {
    try {
        const client = await exports.cpapPool.connect();
...
exports.testCpapConnection = testCpapConnection;
// Get CPAP database statistics
const getCpapDbStats = async () => {
    try {
        const client = await exports.cpapPool.connect();
...
exports.getCpapDbStats = getCpapDbStats;
// Graceful shutdown for CPAP pool
const closeCpapPool = async () => {
    try {
        await exports.cpapPool.end();
...
exports.closeCpapPool = closeCpapPool;
// Handle process termination
process.on('SIGINT', exports.closeCpapPool);
process.on('SIGTERM', exports.closeCpapPool);
exports.default = exports.cpapPool;
//# sourceMappingURL=cpapDatabase.js.map